...
func GetRelated(ctx context.Context, g graph.Graph, t, i, k string, h url.URL, q QueryParams) (*core.Document, *core.Error) {
...
func (tx *Tx) GetRelated(t, i, k string, h url.URL, q QueryParams) (*core.Document, *core.Error) {
